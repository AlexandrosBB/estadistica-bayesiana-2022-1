...
$$	
      ...
      Aplicando el Torema de Bayes se tiene que:
      $$
    ...
    c. Muestre que la probabilidad pedida en este problema es $p = \frac{ o }{ 1 + o } = \frac{ 16 }{ 43 } \approx 0.372$.
        ...
        Dado que $o=p/(1-p)$ (esta contidad se conoce como *odd ratio*), despejando para $p$ se tiene que $o-op = p$ y por lo tanto $p = o/(1+o)$. Así, se tiene que 
        $$
